...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.V1beta1PodDisruptionBudgetStatus = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.UnversionedTime);
  }
   ...
   * @param disruptedPods {Object.<String, module:io.kubernetes.js/io.kubernetes.js.models/UnversionedTime>} DisruptedPods contains information about pods whose eviction was processed by the API server eviction subresource handler but has not yet been observed by the PodDisruptionBudget controller. A pod will be in this map from the time when the API server processed the eviction request to the time when the pod is seen by PDB controller as having been marked for deletion (or after a timeout). The key in the map is the name of the pod and the value is the time when the API server processed the eviction request. If the deletion didn't occur and a pod is still there it will be removed from the list automatically by PodDisruptionBudget controller after some time. If everything goes smooth this map should be empty for the most of the time. Large number of entries in the map may indicate problems with pod deletions.
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('disruptedPods')) {
        obj['disruptedPods'] = ApiClient.convertToType(data['disruptedPods'], {'String': UnversionedTime});
      }
   ...
   * @member {Object.<String, module:io.kubernetes.js/io.kubernetes.js.models/UnversionedTime>} disruptedPods
   */
