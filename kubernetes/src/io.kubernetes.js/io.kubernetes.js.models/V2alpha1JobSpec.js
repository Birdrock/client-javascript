...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.V2alpha1JobSpec = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.UnversionedLabelSelector, root.KubernetesJsClient.V1PodTemplateSpec);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.models/V2alpha1JobSpec
   ...
   * @alias module:io.kubernetes.js/io.kubernetes.js.models/V2alpha1JobSpec
   * @class
   ...
   * @param {module:io.kubernetes.js/io.kubernetes.js.models/V2alpha1JobSpec} obj Optional instance to populate.
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V2alpha1JobSpec} The populated <code>V2alpha1JobSpec</code> instance.
   */
