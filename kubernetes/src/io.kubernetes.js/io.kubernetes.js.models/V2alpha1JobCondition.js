...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.V2alpha1JobCondition = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.UnversionedTime);
  }
   ...
   * @module io.kubernetes.js/io.kubernetes.js.models/V2alpha1JobCondition
   ...
   * @alias module:io.kubernetes.js/io.kubernetes.js.models/V2alpha1JobCondition
   * @class
   ...
   * @param {module:io.kubernetes.js/io.kubernetes.js.models/V2alpha1JobCondition} obj Optional instance to populate.
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V2alpha1JobCondition} The populated <code>V2alpha1JobCondition</code> instance.
   */
