...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['io.kubernetes.js/ApiClient', 'io.kubernetes.js/io.kubernetes.js.models/UnversionedLabelSelector', 'io.kubernetes.js/io.kubernetes.js.models/V1PodTemplateSpec', 'io.kubernetes.js/io.kubernetes.js.models/V1beta1DeploymentStrategy', 'io.kubernetes.js/io.kubernetes.js.models/V1beta1RollbackConfig'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UnversionedLabelSelector'), require('./V1PodTemplateSpec'), require('./V1beta1DeploymentStrategy'), require('./V1beta1RollbackConfig'));
  } else {
    // Browser globals (root is window)
    if (!root.KubernetesJsClient) {
      root.KubernetesJsClient = {};
    }
    root.KubernetesJsClient.V1beta1DeploymentSpec = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.UnversionedLabelSelector, root.KubernetesJsClient.V1PodTemplateSpec, root.KubernetesJsClient.V1beta1DeploymentStrategy, root.KubernetesJsClient.V1beta1RollbackConfig);
  }
}(this, function(ApiClient, UnversionedLabelSelector, V1PodTemplateSpec, V1beta1DeploymentStrategy, V1beta1RollbackConfig) {
  'use strict';
   ...
   * @module io.kubernetes.js/io.kubernetes.js.models/V1beta1DeploymentSpec
   ...
   * @alias module:io.kubernetes.js/io.kubernetes.js.models/V1beta1DeploymentSpec
   * @class
   ...
   * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1DeploymentSpec} obj Optional instance to populate.
   * @return {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1DeploymentSpec} The populated <code>V1beta1DeploymentSpec</code> instance.
   */
   ...
   * @member {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1RollbackConfig} rollbackTo
   */
   ...
   * @member {module:io.kubernetes.js/io.kubernetes.js.models/V1beta1DeploymentStrategy} strategy
   */
