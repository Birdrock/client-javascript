...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['io.kubernetes.js/ApiClient', 'io.kubernetes.js/io.kubernetes.js.models/UnversionedTime', 'io.kubernetes.js/io.kubernetes.js.models/V1ContainerStatus', 'io.kubernetes.js/io.kubernetes.js.models/V1PodCondition'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UnversionedTime'), require('./V1ContainerStatus'), require('./V1PodCondition'));
  } else {
    // Browser globals (root is window)
    if (!root.KubernetesJsClient) {
      root.KubernetesJsClient = {};
    }
    root.KubernetesJsClient.V1PodStatus = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.UnversionedTime, root.KubernetesJsClient.V1ContainerStatus, root.KubernetesJsClient.V1PodCondition);
  }
}(this, function(ApiClient, UnversionedTime, V1ContainerStatus, V1PodCondition) {
  'use strict';
