...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['io.kubernetes.js/ApiClient', 'io.kubernetes.js/io.kubernetes.js.models/UnversionedTime', 'io.kubernetes.js/io.kubernetes.js.models/V1EventSource', 'io.kubernetes.js/io.kubernetes.js.models/V1ObjectMeta', 'io.kubernetes.js/io.kubernetes.js.models/V1ObjectReference'], factory);
    ...
    root.KubernetesJsClient.V1Event = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.UnversionedTime, root.KubernetesJsClient.V1EventSource, root.KubernetesJsClient.V1ObjectMeta, root.KubernetesJsClient.V1ObjectReference);
  }
   ...
   * @member {module:io.kubernetes.js/io.kubernetes.js.models/UnversionedTime} firstTimestamp
   */
   ...
   * @member {module:io.kubernetes.js/io.kubernetes.js.models/UnversionedTime} lastTimestamp
   */
