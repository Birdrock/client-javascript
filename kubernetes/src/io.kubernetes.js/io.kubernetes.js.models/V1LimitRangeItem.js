...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.V1LimitRangeItem = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.ResourceQuantity);
  }
   ...
   * @member {Object.<String, module:io.kubernetes.js/io.kubernetes.js.models/ResourceQuantity>} default
   */
  exports.prototype['default'] = undefined;
  /**
   * DefaultRequest is the default resource requirement request value by resource name if resource request is omitted.
   * @member {Object.<String, module:io.kubernetes.js/io.kubernetes.js.models/ResourceQuantity>} defaultRequest
   */
  exports.prototype['defaultRequest'] = undefined;
  /**
   * Max usage constraints on this kind by resource name.
   * @member {Object.<String, module:io.kubernetes.js/io.kubernetes.js.models/ResourceQuantity>} max
   */
  exports.prototype['max'] = undefined;
  /**
   * MaxLimitRequestRatio if specified, the named resource must have a request and limit that are both non-zero where limit divided by request is less than or equal to the enumerated value; this represents the max burst for the named resource.
   * @member {Object.<String, module:io.kubernetes.js/io.kubernetes.js.models/ResourceQuantity>} maxLimitRequestRatio
   */
  exports.prototype['maxLimitRequestRatio'] = undefined;
  /**
   * Min usage constraints on this kind by resource name.
   * @member {Object.<String, module:io.kubernetes.js/io.kubernetes.js.models/ResourceQuantity>} min
   */
