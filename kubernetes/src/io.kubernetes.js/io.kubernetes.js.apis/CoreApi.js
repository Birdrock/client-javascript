...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['io.kubernetes.js/ApiClient', 'io.kubernetes.js/io.kubernetes.js.models/UnversionedAPIVersions'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../io.kubernetes.js.models/UnversionedAPIVersions'));
  } else {
    // Browser globals (root is window)
    if (!root.KubernetesJsClient) {
      root.KubernetesJsClient = {};
    }
    root.KubernetesJsClient.CoreApi = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.UnversionedAPIVersions);
  }
}(this, function(ApiClient, UnversionedAPIVersions) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/UnversionedAPIVersions} data The data returned by the service call.
     ...
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/UnversionedAPIVersions}
     */
    this.getAPIVersions = function(callback) {
      ...
      var returnType = UnversionedAPIVersions;
