...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KubernetesJsClient.BatchV1Api = factory(root.KubernetesJsClient.ApiClient, root.KubernetesJsClient.UnversionedAPIResourceList, root.KubernetesJsClient.UnversionedPatch, root.KubernetesJsClient.UnversionedStatus, root.KubernetesJsClient.V1DeleteOptions, root.KubernetesJsClient.V1Job, root.KubernetesJsClient.V1JobList);
  }
}(this, function(ApiClient, UnversionedAPIResourceList, UnversionedPatch, UnversionedStatus, V1DeleteOptions, V1Job, V1JobList) {
  'use strict';

  /**
   * BatchV1 service.
   * @module io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api
   * @version 1.0-snapshot
   */

  /**
   * Constructs a new BatchV1Api. 
   * @alias module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~createNamespacedJobCallback
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~createNamespacedJobCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~deleteCollectionNamespacedJobCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~deleteCollectionNamespacedJobCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~deleteNamespacedJobCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/UnversionedStatus} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~deleteNamespacedJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/UnversionedStatus}
     */
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~getAPIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~getAPIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~listJobForAllNamespacesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~listJobForAllNamespacesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~listNamespacedJobCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1JobList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} opts.timeoutSeconds Timeout for the list/watch call.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~listNamespacedJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1JobList}
     */
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~patchNamespacedJobCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1Job} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~patchNamespacedJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1Job}
     */
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~patchNamespacedJobStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1Job} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~patchNamespacedJobStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1Job}
     */
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~readNamespacedJobCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1Job} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~readNamespacedJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1Job}
     */
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~readNamespacedJobStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1Job} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~readNamespacedJobStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1Job}
     */
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~replaceNamespacedJobCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1Job} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~replaceNamespacedJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1Job}
     */
     ...
     * @callback module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~replaceNamespacedJobStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:io.kubernetes.js/io.kubernetes.js.models/V1Job} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:io.kubernetes.js/io.kubernetes.js.apis/BatchV1Api~replaceNamespacedJobStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:io.kubernetes.js/io.kubernetes.js.models/V1Job}
     */
