# KubernetesJsClient.PolicyV1beta1Api
...
var apiInstance = new KubernetesJsClient.PolicyV1beta1Api();
...
> UnversionedStatus deleteCollectionNamespacedPodDisruptionBudget(namespace, opts)
...
> UnversionedStatus deleteNamespacedPodDisruptionBudget(name, namespace, body, opts)
