# KubernetesJsClient.BatchV2alpha1Api
...
var apiInstance = new KubernetesJsClient.BatchV2alpha1Api();
...
# **createNamespacedJob**
> V2alpha1Job createNamespacedJob(namespacebody, opts)
...
var body = new KubernetesJsClient.V2alpha1Job(); // V2alpha1Job | 
...
> UnversionedStatus deleteCollectionNamespacedCronJob(namespace, opts)
...
> UnversionedStatus deleteCollectionNamespacedScheduledJob(namespace, opts)
...
> UnversionedStatus deleteNamespacedCronJob(name, namespace, body, opts)
...
> UnversionedStatus deleteNamespacedScheduledJob(name, namespace, body, opts)
...
> V2alpha1JobList listJobForAllNamespaces(opts)
...
# **listNamespacedJob**
> V2alpha1JobList listNamespacedJob(namespace, opts)
...
# **patchNamespacedJob**
> V2alpha1Job patchNamespacedJob(name, namespace, body, opts)
...
> V2alpha1Job patchNamespacedJobStatus(name, namespace, body, opts)
...
# **readNamespacedJob**
> V2alpha1Job readNamespacedJob(name, namespace, , opts)
...
> V2alpha1Job readNamespacedJobStatus(name, namespace, , opts)
...
> V2alpha1Job replaceNamespacedJob(name, namespace, body, opts)
...
> V2alpha1Job replaceNamespacedJobStatus(name, namespace, body, opts)
