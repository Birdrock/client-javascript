# KubernetesJsClient.AuthorizationV1beta1Api
...
> V1beta1LocalSubjectAccessReview createNamespacedLocalSubjectAccessReview(body, namespace, opts)
...
var apiInstance = new KubernetesJsClient.AuthorizationV1beta1Api();
...
apiInstance.createNamespacedLocalSubjectAccessReview(body, namespace, opts, callback);
```
