...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1JobStatus();
  });
  ...
  describe('V1beta1JobStatus', function() {
    it('should create an instance of V1beta1JobStatus', function() {
      // uncomment below and update the code to test V1beta1JobStatus
      //var instane = new KubernetesJsClient.V1beta1JobStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1JobStatus);
    });
