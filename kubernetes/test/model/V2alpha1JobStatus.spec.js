...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2alpha1JobStatus();
  });
  ...
  describe('V2alpha1JobStatus', function() {
    it('should create an instance of V2alpha1JobStatus', function() {
      // uncomment below and update the code to test V2alpha1JobStatus
      //var instane = new KubernetesJsClient.V2alpha1JobStatus();
      //expect(instance).to.be.a(KubernetesJsClient.V2alpha1JobStatus);
    });
