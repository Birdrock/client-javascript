...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1JobSpec();
  });
  ...
  describe('V1beta1JobSpec', function() {
    it('should create an instance of V1beta1JobSpec', function() {
      // uncomment below and update the code to test V1beta1JobSpec
      //var instane = new KubernetesJsClient.V1beta1JobSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1JobSpec);
    });
    ...
    it('should have the property autoSelector (base name: "autoSelector")', function() {
      // uncomment below and update the code to test the property autoSelector
      //var instane = new KubernetesJsClient.V1beta1JobSpec();
      //expect(instance).to.be();
    });
