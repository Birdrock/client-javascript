...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V1beta1DeploymentSpec();
  });
  ...
  describe('V1beta1DeploymentSpec', function() {
    it('should create an instance of V1beta1DeploymentSpec', function() {
      // uncomment below and update the code to test V1beta1DeploymentSpec
      //var instane = new KubernetesJsClient.V1beta1DeploymentSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V1beta1DeploymentSpec);
    });
