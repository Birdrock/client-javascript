...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesJsClient.V2alpha1JobSpec();
  });
  ...
  describe('V2alpha1JobSpec', function() {
    it('should create an instance of V2alpha1JobSpec', function() {
      // uncomment below and update the code to test V2alpha1JobSpec
      //var instane = new KubernetesJsClient.V2alpha1JobSpec();
      //expect(instance).to.be.a(KubernetesJsClient.V2alpha1JobSpec);
    });
