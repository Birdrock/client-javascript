...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1beta1PodDisruptionBudgetStatus();
  });
  ...
  describe('V1beta1PodDisruptionBudgetStatus', function() {
    it('should create an instance of V1beta1PodDisruptionBudgetStatus', function() {
      ...
      //var instane = new Kubernetes.V1beta1PodDisruptionBudgetStatus();
      //expect(instance).to.be.a(Kubernetes.V1beta1PodDisruptionBudgetStatus);
    });
