...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1WeightedPodAffinityTerm();
  });
  ...
  describe('V1WeightedPodAffinityTerm', function() {
    it('should create an instance of V1WeightedPodAffinityTerm', function() {
      ...
      //var instane = new Kubernetes.V1WeightedPodAffinityTerm();
      //expect(instance).to.be.a(Kubernetes.V1WeightedPodAffinityTerm);
    });
