...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1ReplicationControllerStatus();
  });
  ...
  describe('V1ReplicationControllerStatus', function() {
    it('should create an instance of V1ReplicationControllerStatus', function() {
      ...
      //var instane = new Kubernetes.V1ReplicationControllerStatus();
      //expect(instance).to.be.a(Kubernetes.V1ReplicationControllerStatus);
    });
