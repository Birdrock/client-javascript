...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1PersistentVolumeClaimSpec();
  });
  ...
  describe('V1PersistentVolumeClaimSpec', function() {
    it('should create an instance of V1PersistentVolumeClaimSpec', function() {
      ...
      //var instane = new Kubernetes.V1PersistentVolumeClaimSpec();
      //expect(instance).to.be.a(Kubernetes.V1PersistentVolumeClaimSpec);
    });
