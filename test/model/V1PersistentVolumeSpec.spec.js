...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1PersistentVolumeSpec();
  });
  ...
  describe('V1PersistentVolumeSpec', function() {
    it('should create an instance of V1PersistentVolumeSpec', function() {
      ...
      //var instane = new Kubernetes.V1PersistentVolumeSpec();
      //expect(instance).to.be.a(Kubernetes.V1PersistentVolumeSpec);
    });
