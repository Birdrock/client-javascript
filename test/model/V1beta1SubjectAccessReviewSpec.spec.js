...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1beta1SubjectAccessReviewSpec();
  });
  ...
  describe('V1beta1SubjectAccessReviewSpec', function() {
    it('should create an instance of V1beta1SubjectAccessReviewSpec', function() {
      ...
      //var instane = new Kubernetes.V1beta1SubjectAccessReviewSpec();
      //expect(instance).to.be.a(Kubernetes.V1beta1SubjectAccessReviewSpec);
    });
