...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1PersistentVolumeClaimStatus();
  });
  ...
  describe('V1PersistentVolumeClaimStatus', function() {
    it('should create an instance of V1PersistentVolumeClaimStatus', function() {
      ...
      //var instane = new Kubernetes.V1PersistentVolumeClaimStatus();
      //expect(instance).to.be.a(Kubernetes.V1PersistentVolumeClaimStatus);
    });
