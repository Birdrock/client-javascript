...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1HorizontalPodAutoscalerSpec();
  });
  ...
  describe('V1HorizontalPodAutoscalerSpec', function() {
    it('should create an instance of V1HorizontalPodAutoscalerSpec', function() {
      ...
      //var instane = new Kubernetes.V1HorizontalPodAutoscalerSpec();
      //expect(instance).to.be.a(Kubernetes.V1HorizontalPodAutoscalerSpec);
    });
