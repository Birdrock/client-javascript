...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1beta1CertificateSigningRequestSpec();
  });
  ...
  describe('V1beta1CertificateSigningRequestSpec', function() {
    it('should create an instance of V1beta1CertificateSigningRequestSpec', function() {
      ...
      //var instane = new Kubernetes.V1beta1CertificateSigningRequestSpec();
      //expect(instance).to.be.a(Kubernetes.V1beta1CertificateSigningRequestSpec);
    });
