...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1ContainerStateTerminated();
  });
  ...
  describe('V1ContainerStateTerminated', function() {
    it('should create an instance of V1ContainerStateTerminated', function() {
      ...
      //var instane = new Kubernetes.V1ContainerStateTerminated();
      //expect(instance).to.be.a(Kubernetes.V1ContainerStateTerminated);
    });
