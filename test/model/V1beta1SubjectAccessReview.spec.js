...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1beta1SubjectAccessReview();
  });
  ...
  describe('V1beta1SubjectAccessReview', function() {
    it('should create an instance of V1beta1SubjectAccessReview', function() {
      ...
      //var instane = new Kubernetes.V1beta1SubjectAccessReview();
      //expect(instance).to.be.a(Kubernetes.V1beta1SubjectAccessReview);
    });
