...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1HorizontalPodAutoscalerStatus();
  });
  ...
  describe('V1HorizontalPodAutoscalerStatus', function() {
    it('should create an instance of V1HorizontalPodAutoscalerStatus', function() {
      ...
      //var instane = new Kubernetes.V1HorizontalPodAutoscalerStatus();
      //expect(instance).to.be.a(Kubernetes.V1HorizontalPodAutoscalerStatus);
    });
