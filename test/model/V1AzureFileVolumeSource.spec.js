...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1AzureFileVolumeSource();
  });
  ...
  describe('V1AzureFileVolumeSource', function() {
    it('should create an instance of V1AzureFileVolumeSource', function() {
      ...
      //var instane = new Kubernetes.V1AzureFileVolumeSource();
      //expect(instance).to.be.a(Kubernetes.V1AzureFileVolumeSource);
    });
