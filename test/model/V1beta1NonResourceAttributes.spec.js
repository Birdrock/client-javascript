...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1beta1NonResourceAttributes();
  });
  ...
  describe('V1beta1NonResourceAttributes', function() {
    it('should create an instance of V1beta1NonResourceAttributes', function() {
      ...
      //var instane = new Kubernetes.V1beta1NonResourceAttributes();
      //expect(instance).to.be.a(Kubernetes.V1beta1NonResourceAttributes);
    });
