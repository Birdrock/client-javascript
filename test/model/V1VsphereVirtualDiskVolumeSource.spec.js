...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1VsphereVirtualDiskVolumeSource();
  });
  ...
  describe('V1VsphereVirtualDiskVolumeSource', function() {
    it('should create an instance of V1VsphereVirtualDiskVolumeSource', function() {
      ...
      //var instane = new Kubernetes.V1VsphereVirtualDiskVolumeSource();
      //expect(instance).to.be.a(Kubernetes.V1VsphereVirtualDiskVolumeSource);
    });
