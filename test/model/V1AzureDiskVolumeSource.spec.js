...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1AzureDiskVolumeSource();
  });
  ...
  describe('V1AzureDiskVolumeSource', function() {
    it('should create an instance of V1AzureDiskVolumeSource', function() {
      ...
      //var instane = new Kubernetes.V1AzureDiskVolumeSource();
      //expect(instance).to.be.a(Kubernetes.V1AzureDiskVolumeSource);
    });
