...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.UnversionedServerAddressByClientCIDR();
  });
  ...
  describe('UnversionedServerAddressByClientCIDR', function() {
    it('should create an instance of UnversionedServerAddressByClientCIDR', function() {
      ...
      //var instane = new Kubernetes.UnversionedServerAddressByClientCIDR();
      //expect(instance).to.be.a(Kubernetes.UnversionedServerAddressByClientCIDR);
    });
