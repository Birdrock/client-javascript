...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1beta1ReplicaSetStatus();
  });
  ...
  describe('V1beta1ReplicaSetStatus', function() {
    it('should create an instance of V1beta1ReplicaSetStatus', function() {
      ...
      //var instane = new Kubernetes.V1beta1ReplicaSetStatus();
      //expect(instance).to.be.a(Kubernetes.V1beta1ReplicaSetStatus);
    });
