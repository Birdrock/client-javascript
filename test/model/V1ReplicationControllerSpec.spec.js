...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.V1ReplicationControllerSpec();
  });
  ...
  describe('V1ReplicationControllerSpec', function() {
    it('should create an instance of V1ReplicationControllerSpec', function() {
      ...
      //var instane = new Kubernetes.V1ReplicationControllerSpec();
      //expect(instance).to.be.a(Kubernetes.V1ReplicationControllerSpec);
    });
