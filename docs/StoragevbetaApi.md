...
> V1Status deleteStorageV1beta1CollectionStorageClass(opts)
...
> V1Status deleteStorageV1beta1StorageClass(name, body, opts)
...
> V1APIResourceList getStorageV1beta1APIResources()
...
> V1WatchEvent watchStorageV1beta1StorageClass(name, opts)
...
> V1WatchEvent watchStorageV1beta1StorageClassList(opts)
