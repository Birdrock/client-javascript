...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1Namespace', 'model/V1Binding', 'model/V1ConfigMap', 'model/V1Endpoints', 'model/V1Event', 'model/V1beta1Eviction', 'model/V1LimitRange', 'model/V1PersistentVolumeClaim', 'model/V1Pod', 'model/V1PodTemplate', 'model/V1ReplicationController', 'model/V1ResourceQuota', 'model/V1Secret', 'model/V1Service', 'model/V1ServiceAccount', 'model/V1Node', 'model/V1PersistentVolume', 'model/V1Status', 'model/V1DeleteOptions', 'model/V1APIResourceList', 'model/V1ComponentStatusList', 'model/V1ConfigMapList', 'model/V1EndpointsList', 'model/V1EventList', 'model/V1LimitRangeList', 'model/V1NamespaceList', 'model/V1PersistentVolumeClaimList', 'model/V1PodList', 'model/V1PodTemplateList', 'model/V1ReplicationControllerList', 'model/V1ResourceQuotaList', 'model/V1SecretList', 'model/V1ServiceList', 'model/V1ServiceAccountList', 'model/V1NodeList', 'model/V1PersistentVolumeList', 'model/V1Patch', 'model/V1Scale', 'model/V1ComponentStatus', 'model/V1WatchEvent'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V1Namespace'), require('../model/V1Binding'), require('../model/V1ConfigMap'), require('../model/V1Endpoints'), require('../model/V1Event'), require('../model/V1beta1Eviction'), require('../model/V1LimitRange'), require('../model/V1PersistentVolumeClaim'), require('../model/V1Pod'), require('../model/V1PodTemplate'), require('../model/V1ReplicationController'), require('../model/V1ResourceQuota'), require('../model/V1Secret'), require('../model/V1Service'), require('../model/V1ServiceAccount'), require('../model/V1Node'), require('../model/V1PersistentVolume'), require('../model/V1Status'), require('../model/V1DeleteOptions'), require('../model/V1APIResourceList'), require('../model/V1ComponentStatusList'), require('../model/V1ConfigMapList'), require('../model/V1EndpointsList'), require('../model/V1EventList'), require('../model/V1LimitRangeList'), require('../model/V1NamespaceList'), require('../model/V1PersistentVolumeClaimList'), require('../model/V1PodList'), require('../model/V1PodTemplateList'), require('../model/V1ReplicationControllerList'), require('../model/V1ResourceQuotaList'), require('../model/V1SecretList'), require('../model/V1ServiceList'), require('../model/V1ServiceAccountList'), require('../model/V1NodeList'), require('../model/V1PersistentVolumeList'), require('../model/V1Patch'), require('../model/V1Scale'), require('../model/V1ComponentStatus'), require('../model/V1WatchEvent'));
  } else {
    // Browser globals (root is window)
    if (!root.Kubernetes) {
      root.Kubernetes = {};
    }
    root.Kubernetes.CorevApi = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1Namespace, root.Kubernetes.V1Binding, root.Kubernetes.V1ConfigMap, root.Kubernetes.V1Endpoints, root.Kubernetes.V1Event, root.Kubernetes.V1beta1Eviction, root.Kubernetes.V1LimitRange, root.Kubernetes.V1PersistentVolumeClaim, root.Kubernetes.V1Pod, root.Kubernetes.V1PodTemplate, root.Kubernetes.V1ReplicationController, root.Kubernetes.V1ResourceQuota, root.Kubernetes.V1Secret, root.Kubernetes.V1Service, root.Kubernetes.V1ServiceAccount, root.Kubernetes.V1Node, root.Kubernetes.V1PersistentVolume, root.Kubernetes.V1Status, root.Kubernetes.V1DeleteOptions, root.Kubernetes.V1APIResourceList, root.Kubernetes.V1ComponentStatusList, root.Kubernetes.V1ConfigMapList, root.Kubernetes.V1EndpointsList, root.Kubernetes.V1EventList, root.Kubernetes.V1LimitRangeList, root.Kubernetes.V1NamespaceList, root.Kubernetes.V1PersistentVolumeClaimList, root.Kubernetes.V1PodList, root.Kubernetes.V1PodTemplateList, root.Kubernetes.V1ReplicationControllerList, root.Kubernetes.V1ResourceQuotaList, root.Kubernetes.V1SecretList, root.Kubernetes.V1ServiceList, root.Kubernetes.V1ServiceAccountList, root.Kubernetes.V1NodeList, root.Kubernetes.V1PersistentVolumeList, root.Kubernetes.V1Patch, root.Kubernetes.V1Scale, root.Kubernetes.V1ComponentStatus, root.Kubernetes.V1WatchEvent);
  }
}(this, function(ApiClient, V1Namespace, V1Binding, V1ConfigMap, V1Endpoints, V1Event, V1beta1Eviction, V1LimitRange, V1PersistentVolumeClaim, V1Pod, V1PodTemplate, V1ReplicationController, V1ResourceQuota, V1Secret, V1Service, V1ServiceAccount, V1Node, V1PersistentVolume, V1Status, V1DeleteOptions, V1APIResourceList, V1ComponentStatusList, V1ConfigMapList, V1EndpointsList, V1EventList, V1LimitRangeList, V1NamespaceList, V1PersistentVolumeClaimList, V1PodList, V1PodTemplateList, V1ReplicationControllerList, V1ResourceQuotaList, V1SecretList, V1ServiceList, V1ServiceAccountList, V1NodeList, V1PersistentVolumeList, V1Patch, V1Scale, V1ComponentStatus, V1WatchEvent) {
  'use strict';
