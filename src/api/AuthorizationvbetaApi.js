...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1beta1LocalSubjectAccessReview', 'model/V1beta1SelfSubjectAccessReview', 'model/V1beta1SubjectAccessReview', 'model/UnversionedAPIResourceList'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V1beta1LocalSubjectAccessReview'), require('../model/V1beta1SelfSubjectAccessReview'), require('../model/V1beta1SubjectAccessReview'), require('../model/UnversionedAPIResourceList'));
  } else {
    // Browser globals (root is window)
    if (!root.Kubernetes) {
      root.Kubernetes = {};
    }
    root.Kubernetes.AuthorizationvbetaApi = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1beta1LocalSubjectAccessReview, root.Kubernetes.V1beta1SelfSubjectAccessReview, root.Kubernetes.V1beta1SubjectAccessReview, root.Kubernetes.UnversionedAPIResourceList);
  }
}(this, function(ApiClient, V1beta1LocalSubjectAccessReview, V1beta1SelfSubjectAccessReview, V1beta1SubjectAccessReview, UnversionedAPIResourceList) {
  'use strict';
