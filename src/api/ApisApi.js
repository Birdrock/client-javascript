...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1APIGroupList'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V1APIGroupList'));
  } else {
    // Browser globals (root is window)
    if (!root.Kubernetes) {
      root.Kubernetes = {};
    }
    root.Kubernetes.ApisApi = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1APIGroupList);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/V1APIGroupList} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/V1APIGroupList}
     */
