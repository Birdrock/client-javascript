...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1beta1TokenReview', 'model/UnversionedAPIResourceList'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V1beta1TokenReview'), require('../model/UnversionedAPIResourceList'));
  } else {
    // Browser globals (root is window)
    if (!root.Kubernetes) {
      root.Kubernetes = {};
    }
    root.Kubernetes.AuthenticationvbetaApi = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1beta1TokenReview, root.Kubernetes.UnversionedAPIResourceList);
  }
}(this, function(ApiClient, V1beta1TokenReview, UnversionedAPIResourceList) {
  'use strict';
