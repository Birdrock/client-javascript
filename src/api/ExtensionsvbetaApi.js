...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1beta1DaemonSet', 'model/V1beta1Deployment', 'model/V1beta1DeploymentRollback', 'model/V1beta1HorizontalPodAutoscaler', 'model/V1beta1Ingress', 'model/V1beta1NetworkPolicy', 'model/V1beta1ReplicaSet', 'model/V1beta1PodSecurityPolicy', 'model/V1beta1ThirdPartyResource', 'model/V1Status', 'model/V1DeleteOptions', 'model/V1APIResourceList', 'model/V1beta1DaemonSetList', 'model/V1beta1DeploymentList', 'model/V1beta1HorizontalPodAutoscalerList', 'model/V1beta1IngressList', 'model/V1beta1NetworkPolicyList', 'model/V1beta1ReplicaSetList', 'model/V1beta1PodSecurityPolicyList', 'model/V1beta1ThirdPartyResourceList', 'model/V1Patch', 'model/V1beta1Scale', 'model/V1WatchEvent'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V1beta1DaemonSet'), require('../model/V1beta1Deployment'), require('../model/V1beta1DeploymentRollback'), require('../model/V1beta1HorizontalPodAutoscaler'), require('../model/V1beta1Ingress'), require('../model/V1beta1NetworkPolicy'), require('../model/V1beta1ReplicaSet'), require('../model/V1beta1PodSecurityPolicy'), require('../model/V1beta1ThirdPartyResource'), require('../model/V1Status'), require('../model/V1DeleteOptions'), require('../model/V1APIResourceList'), require('../model/V1beta1DaemonSetList'), require('../model/V1beta1DeploymentList'), require('../model/V1beta1HorizontalPodAutoscalerList'), require('../model/V1beta1IngressList'), require('../model/V1beta1NetworkPolicyList'), require('../model/V1beta1ReplicaSetList'), require('../model/V1beta1PodSecurityPolicyList'), require('../model/V1beta1ThirdPartyResourceList'), require('../model/V1Patch'), require('../model/V1beta1Scale'), require('../model/V1WatchEvent'));
  } else {
    // Browser globals (root is window)
    if (!root.Kubernetes) {
      root.Kubernetes = {};
    }
    root.Kubernetes.ExtensionsvbetaApi = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1beta1DaemonSet, root.Kubernetes.V1beta1Deployment, root.Kubernetes.V1beta1DeploymentRollback, root.Kubernetes.V1beta1HorizontalPodAutoscaler, root.Kubernetes.V1beta1Ingress, root.Kubernetes.V1beta1NetworkPolicy, root.Kubernetes.V1beta1ReplicaSet, root.Kubernetes.V1beta1PodSecurityPolicy, root.Kubernetes.V1beta1ThirdPartyResource, root.Kubernetes.V1Status, root.Kubernetes.V1DeleteOptions, root.Kubernetes.V1APIResourceList, root.Kubernetes.V1beta1DaemonSetList, root.Kubernetes.V1beta1DeploymentList, root.Kubernetes.V1beta1HorizontalPodAutoscalerList, root.Kubernetes.V1beta1IngressList, root.Kubernetes.V1beta1NetworkPolicyList, root.Kubernetes.V1beta1ReplicaSetList, root.Kubernetes.V1beta1PodSecurityPolicyList, root.Kubernetes.V1beta1ThirdPartyResourceList, root.Kubernetes.V1Patch, root.Kubernetes.V1beta1Scale, root.Kubernetes.V1WatchEvent);
  }
}(this, function(ApiClient, V1beta1DaemonSet, V1beta1Deployment, V1beta1DeploymentRollback, V1beta1HorizontalPodAutoscaler, V1beta1Ingress, V1beta1NetworkPolicy, V1beta1ReplicaSet, V1beta1PodSecurityPolicy, V1beta1ThirdPartyResource, V1Status, V1DeleteOptions, V1APIResourceList, V1beta1DaemonSetList, V1beta1DeploymentList, V1beta1HorizontalPodAutoscalerList, V1beta1IngressList, V1beta1NetworkPolicyList, V1beta1ReplicaSetList, V1beta1PodSecurityPolicyList, V1beta1ThirdPartyResourceList, V1Patch, V1beta1Scale, V1WatchEvent) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ExtensionsvbetaApi~createExtensionsV1beta1PodSecurityPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1beta1PodSecurityPolicy} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * create a PodSecurityPolicy
     * @param {module:model/V1beta1PodSecurityPolicy} body 
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:api/ExtensionsvbetaApi~createExtensionsV1beta1PodSecurityPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1beta1PodSecurityPolicy}
     */
    this.createExtensionsV1beta1PodSecurityPolicy = function(body, opts, callback) {
      opts = opts || {};
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body == undefined || body == null) {
        throw "Missing the required parameter 'body' when calling createExtensionsV1beta1PodSecurityPolicy";
      }
     ...
     * @callback module:api/ExtensionsvbetaApi~deleteExtensionsV1beta1CollectionPodSecurityPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Integer} opts.timeoutSeconds Timeout for the list/watch call.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:api/ExtensionsvbetaApi~deleteExtensionsV1beta1CollectionPodSecurityPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1Status}
     */
    this.deleteExtensionsV1beta1CollectionPodSecurityPolicy = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     * @callback module:api/ExtensionsvbetaApi~deleteExtensionsV1beta1PodSecurityPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Integer} opts.gracePeriodSeconds The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.
     * @param {Boolean} opts.orphanDependents Should the dependent objects be orphaned. If true/false, the \&quot;orphan\&quot; finalizer will be added to/removed from the object&#39;s finalizers list.
     * @param {module:api/ExtensionsvbetaApi~deleteExtensionsV1beta1PodSecurityPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1Status}
     */
    this.deleteExtensionsV1beta1PodSecurityPolicy = function(name, body, opts, callback) {
      opts = opts || {};
      var postBody = body;

      // verify the required parameter 'name' is set
      if (name == undefined || name == null) {
        throw "Missing the required parameter 'name' when calling deleteExtensionsV1beta1PodSecurityPolicy";
      }

      // verify the required parameter 'body' is set
      if (body == undefined || body == null) {
        throw "Missing the required parameter 'body' when calling deleteExtensionsV1beta1PodSecurityPolicy";
      }
     ...
     * @callback module:api/ExtensionsvbetaApi~listExtensionsV1beta1PodSecurityPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1beta1PodSecurityPolicyList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Integer} opts.timeoutSeconds Timeout for the list/watch call.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:api/ExtensionsvbetaApi~listExtensionsV1beta1PodSecurityPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1beta1PodSecurityPolicyList}
     */
    this.listExtensionsV1beta1PodSecurityPolicy = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     * @callback module:api/ExtensionsvbetaApi~patchExtensionsV1beta1PodSecurityPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1beta1PodSecurityPolicy} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:api/ExtensionsvbetaApi~patchExtensionsV1beta1PodSecurityPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1beta1PodSecurityPolicy}
     */
    this.patchExtensionsV1beta1PodSecurityPolicy = function(name, body, opts, callback) {
      opts = opts || {};
      var postBody = body;

      // verify the required parameter 'name' is set
      if (name == undefined || name == null) {
        throw "Missing the required parameter 'name' when calling patchExtensionsV1beta1PodSecurityPolicy";
      }

      // verify the required parameter 'body' is set
      if (body == undefined || body == null) {
        throw "Missing the required parameter 'body' when calling patchExtensionsV1beta1PodSecurityPolicy";
      }
     ...
     * @callback module:api/ExtensionsvbetaApi~readExtensionsV1beta1PodSecurityPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1beta1PodSecurityPolicy} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Boolean} opts.exact Should the export be exact.  Exact export maintains cluster-specific fields like &#39;Namespace&#39;.
     * @param {Boolean} opts._export Should this value be exported.  Export strips fields that a user can not specify.
     * @param {module:api/ExtensionsvbetaApi~readExtensionsV1beta1PodSecurityPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1beta1PodSecurityPolicy}
     */
    this.readExtensionsV1beta1PodSecurityPolicy = function(name, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'name' is set
      if (name == undefined || name == null) {
        throw "Missing the required parameter 'name' when calling readExtensionsV1beta1PodSecurityPolicy";
      }
     ...
     * @callback module:api/ExtensionsvbetaApi~replaceExtensionsV1beta1PodSecurityPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1beta1PodSecurityPolicy} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.pretty If &#39;true&#39;, then the output is pretty printed.
     * @param {module:api/ExtensionsvbetaApi~replaceExtensionsV1beta1PodSecurityPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1beta1PodSecurityPolicy}
     */
    this.replaceExtensionsV1beta1PodSecurityPolicy = function(name, body, opts, callback) {
      opts = opts || {};
      var postBody = body;

      // verify the required parameter 'name' is set
      if (name == undefined || name == null) {
        throw "Missing the required parameter 'name' when calling replaceExtensionsV1beta1PodSecurityPolicy";
      }

      // verify the required parameter 'body' is set
      if (body == undefined || body == null) {
        throw "Missing the required parameter 'body' when calling replaceExtensionsV1beta1PodSecurityPolicy";
      }
     ...
     * @callback module:api/ExtensionsvbetaApi~watchExtensionsV1beta1PodSecurityPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1WatchEvent} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Integer} opts.timeoutSeconds Timeout for the list/watch call.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:api/ExtensionsvbetaApi~watchExtensionsV1beta1PodSecurityPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1WatchEvent}
     */
    this.watchExtensionsV1beta1PodSecurityPolicy = function(name, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'name' is set
      if (name == undefined || name == null) {
        throw "Missing the required parameter 'name' when calling watchExtensionsV1beta1PodSecurityPolicy";
      }
     ...
     * @callback module:api/ExtensionsvbetaApi~watchExtensionsV1beta1PodSecurityPolicyListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1WatchEvent} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Integer} opts.timeoutSeconds Timeout for the list/watch call.
     * @param {Boolean} opts.watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:api/ExtensionsvbetaApi~watchExtensionsV1beta1PodSecurityPolicyListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1WatchEvent}
     */
    this.watchExtensionsV1beta1PodSecurityPolicyList = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
