...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V2alpha1CronJob', 'model/V2alpha1Job', 'model/V1Status', 'model/V1DeleteOptions', 'model/V1APIResourceList', 'model/V2alpha1CronJobList', 'model/V2alpha1JobList', 'model/V1Patch', 'model/V1WatchEvent'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V2alpha1CronJob'), require('../model/V2alpha1Job'), require('../model/V1Status'), require('../model/V1DeleteOptions'), require('../model/V1APIResourceList'), require('../model/V2alpha1CronJobList'), require('../model/V2alpha1JobList'), require('../model/V1Patch'), require('../model/V1WatchEvent'));
  } else {
    // Browser globals (root is window)
    if (!root.Kubernetes) {
      root.Kubernetes = {};
    }
    root.Kubernetes.BatchvalphaApi = factory(root.Kubernetes.ApiClient, root.Kubernetes.V2alpha1CronJob, root.Kubernetes.V2alpha1Job, root.Kubernetes.V1Status, root.Kubernetes.V1DeleteOptions, root.Kubernetes.V1APIResourceList, root.Kubernetes.V2alpha1CronJobList, root.Kubernetes.V2alpha1JobList, root.Kubernetes.V1Patch, root.Kubernetes.V1WatchEvent);
  }
}(this, function(ApiClient, V2alpha1CronJob, V2alpha1Job, V1Status, V1DeleteOptions, V1APIResourceList, V2alpha1CronJobList, V2alpha1JobList, V1Patch, V1WatchEvent) {
  'use strict';
