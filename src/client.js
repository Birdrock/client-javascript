...
// extensions.listExtensionsV1beta1NamespacedDeployment('default', {}, function(error, result) {
//     console.log(error, result);
// });

// extensions.readExtensionsV1beta1NamespacedDeployment('hello-node', 'kubejs', {}, function(error, result) {
//     console.log(error, result);
// });

// extensions.readExtensionsV1beta1NamespacedDeploymentStatus('hello-node', 'default', {}, function(error, result) {
//     console.log(error, result);
// });


const testDep = "{\"kind\":\"Deployment\",\"apiVersion\":\"extensions/v1beta1\",\"metadata\":{\"name\":\"hello-node\",\"creationTimestamp\":null,\"labels\":{\"run\":\"hello-node\"}},\"spec\":{\"replicas\":1,\"selector\":{\"matchLabels\":{\"run\":\"hello-node\"}},\"template\":{\"metadata\":{\"creationTimestamp\":null,\"labels\":{\"run\":\"hello-node\"}},\"spec\":{\"containers\":[{\"name\":\"hello-node\",\"image\":\"hello-node:v1\",\"ports\":[{\"containerPort\":8080}],\"resources\":{}}]}},\"strategy\":{}},\"status\":{}}\n";
...
// extensions.createExtensionsV1beta1NamespacedDeployment('default', JSON.stringify(deployment), {}, function(error, result) {
//     console.log(error, result);
// });

// extensions.readExtensionsV1beta1NamespacedIngress('hello-node', 'default', {}, function(error, result) {
//     console.log(error, result);
// });

const core = new kubernetes.CoreApi(apiClient);
core.getCoreAPIVersions(function(error, result) {
    console.log(error, result);
});

const version = new kubernetes.VersionApi(apiClient);
version.getCodeVersion(function(error, result) {
    console.log(error, result);
});