...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1ServicePort = factory(root.Kubernetes.ApiClient, root.Kubernetes.IntstrIntOrString);
  }
   ...
   * @alias module:model/V1ServicePort
   * @class
   * @param port {Integer} The port that will be exposed by this service.
   */
   ...
   * @param {module:model/V1ServicePort} obj Optional instance to populate.
   * @return {module:model/V1ServicePort} The populated <code>V1ServicePort</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('nodePort')) {
        obj['nodePort'] = ApiClient.convertToType(data['nodePort'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('targetPort')) {
        obj['targetPort'] = IntstrIntOrString.constructFromObject(data['targetPort']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/IntstrIntOrString} targetPort
   */
