...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ContainerPort', 'model/V1EnvFromSource', 'model/V1EnvVar', 'model/V1Lifecycle', 'model/V1Probe', 'model/V1ResourceRequirements', 'model/V1SecurityContext', 'model/V1VolumeMount'], factory);
    ...
    root.Kubernetes.V1Container = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1ContainerPort, root.Kubernetes.V1EnvFromSource, root.Kubernetes.V1EnvVar, root.Kubernetes.V1Lifecycle, root.Kubernetes.V1Probe, root.Kubernetes.V1ResourceRequirements, root.Kubernetes.V1SecurityContext, root.Kubernetes.V1VolumeMount);
  }
   ...
   * @member {Array.<module:model/V1EnvFromSource>} envFrom
   */
