...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ContainerPort', 'model/V1EnvVar', 'model/V1Lifecycle', 'model/V1Probe', 'model/V1ResourceRequirements', 'model/V1SecurityContext', 'model/V1VolumeMount'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V1ContainerPort'), require('./V1EnvVar'), require('./V1Lifecycle'), require('./V1Probe'), require('./V1ResourceRequirements'), require('./V1SecurityContext'), require('./V1VolumeMount'));
  } else {
    // Browser globals (root is window)
    if (!root.Kubernetes) {
      root.Kubernetes = {};
    }
    root.Kubernetes.V1Container = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1ContainerPort, root.Kubernetes.V1EnvVar, root.Kubernetes.V1Lifecycle, root.Kubernetes.V1Probe, root.Kubernetes.V1ResourceRequirements, root.Kubernetes.V1SecurityContext, root.Kubernetes.V1VolumeMount);
  }
}(this, function(ApiClient, V1ContainerPort, V1EnvVar, V1Lifecycle, V1Probe, V1ResourceRequirements, V1SecurityContext, V1VolumeMount) {
  'use strict';
   ...
   * @member {Array.<module:model/V1EnvVar>} env
   */
   ...
   * @member {module:model/V1Lifecycle} lifecycle
   */
   ...
   * @member {module:model/V1Probe} livenessProbe
   */
   ...
   * @member {Array.<module:model/V1ContainerPort>} ports
   */
   ...
   * @member {module:model/V1Probe} readinessProbe
   */
   ...
   * @member {module:model/V1SecurityContext} securityContext
   */
   ...
   * @member {Array.<module:model/V1VolumeMount>} volumeMounts
   */
