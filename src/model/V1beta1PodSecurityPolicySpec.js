...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1beta1FSGroupStrategyOptions', 'model/V1beta1HostPortRange', 'model/V1beta1RunAsUserStrategyOptions', 'model/V1beta1SELinuxStrategyOptions', 'model/V1beta1SupplementalGroupsStrategyOptions'], factory);
    ...
    root.Kubernetes.V1beta1PodSecurityPolicySpec = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1beta1FSGroupStrategyOptions, root.Kubernetes.V1beta1HostPortRange, root.Kubernetes.V1beta1RunAsUserStrategyOptions, root.Kubernetes.V1beta1SELinuxStrategyOptions, root.Kubernetes.V1beta1SupplementalGroupsStrategyOptions);
  }
   ...
   * @module model/V1beta1PodSecurityPolicySpec
   * @version v1.6.0
   */
   ...
   * @alias module:model/V1beta1PodSecurityPolicySpec
   * @class
   * @param fsGroup {module:model/V1beta1FSGroupStrategyOptions} FSGroup is the strategy that will dictate what fs group is used by the SecurityContext.
   * @param runAsUser {module:model/V1beta1RunAsUserStrategyOptions} runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.
   * @param seLinux {module:model/V1beta1SELinuxStrategyOptions} seLinux is the strategy that will dictate the allowable labels that may be set.
   * @param supplementalGroups {module:model/V1beta1SupplementalGroupsStrategyOptions} SupplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
   */
   ...
   * @param {module:model/V1beta1PodSecurityPolicySpec} obj Optional instance to populate.
   * @return {module:model/V1beta1PodSecurityPolicySpec} The populated <code>V1beta1PodSecurityPolicySpec</code> instance.
   */
   ...
   * @member {module:model/V1beta1FSGroupStrategyOptions} fsGroup
   */
   ...
   * @member {Array.<module:model/V1beta1HostPortRange>} hostPorts
   */
   ...
   * @member {module:model/V1beta1RunAsUserStrategyOptions} runAsUser
   */
  exports.prototype['runAsUser'] = undefined;
  /**
   * seLinux is the strategy that will dictate the allowable labels that may be set.
   * @member {module:model/V1beta1SELinuxStrategyOptions} seLinux
   */
  exports.prototype['seLinux'] = undefined;
  /**
   * SupplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
   * @member {module:model/V1beta1SupplementalGroupsStrategyOptions} supplementalGroups
   */
