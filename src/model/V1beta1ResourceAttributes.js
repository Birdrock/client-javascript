...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1beta1ResourceAttributes = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @module model/V1beta1ResourceAttributes
   * @version v1.6.0
   */
   ...
   * @alias module:model/V1beta1ResourceAttributes
   * @class
   */
   ...
   * @param {module:model/V1beta1ResourceAttributes} obj Optional instance to populate.
   * @return {module:model/V1beta1ResourceAttributes} The populated <code>V1beta1ResourceAttributes</code> instance.
   */
