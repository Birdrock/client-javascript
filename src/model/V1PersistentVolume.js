...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ObjectMeta', 'model/V1PersistentVolumeSpec', 'model/V1PersistentVolumeStatus'], factory);
    ...
    root.Kubernetes.V1PersistentVolume = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1ObjectMeta, root.Kubernetes.V1PersistentVolumeSpec, root.Kubernetes.V1PersistentVolumeStatus);
  }
   ...
   * @module model/V1PersistentVolume
   * @version unversioned
   */
   ...
   * @alias module:model/V1PersistentVolume
   * @class
   */
   ...
   * @param {module:model/V1PersistentVolume} obj Optional instance to populate.
   * @return {module:model/V1PersistentVolume} The populated <code>V1PersistentVolume</code> instance.
   */
   ...
   * @member {module:model/V1PersistentVolumeSpec} spec
   */
   ...
   * @member {module:model/V1PersistentVolumeStatus} status
   */
