...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1beta1CertificateSigningRequestCondition'], factory);
    ...
    root.Kubernetes.V1beta1CertificateSigningRequestStatus = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1beta1CertificateSigningRequestCondition);
  }
   ...
   * @module model/V1beta1CertificateSigningRequestStatus
   * @version v1.6.0
   */

  /**
   * Constructs a new <code>V1beta1CertificateSigningRequestStatus</code>.
   * @alias module:model/V1beta1CertificateSigningRequestStatus
   * @class
   */
   ...
   * @param {module:model/V1beta1CertificateSigningRequestStatus} obj Optional instance to populate.
   * @return {module:model/V1beta1CertificateSigningRequestStatus} The populated <code>V1beta1CertificateSigningRequestStatus</code> instance.
   */
   ...
   * @member {Array.<module:model/V1beta1CertificateSigningRequestCondition>} conditions
   */
