...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1alpha1PolicyRule = factory(root.Kubernetes.ApiClient, root.Kubernetes.RuntimeRawExtension);
  }
   ...
   * @module model/V1alpha1PolicyRule
   * @version unversioned
   */
   ...
   * @alias module:model/V1alpha1PolicyRule
   * @class
   ...
   * @param {module:model/V1alpha1PolicyRule} obj Optional instance to populate.
   * @return {module:model/V1alpha1PolicyRule} The populated <code>V1alpha1PolicyRule</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributeRestrictions')) {
        obj['attributeRestrictions'] = RuntimeRawExtension.constructFromObject(data['attributeRestrictions']);
      }
   ...
   * @member {module:model/RuntimeRawExtension} attributeRestrictions
   */
  exports.prototype['attributeRestrictions'] = undefined;
  /**
