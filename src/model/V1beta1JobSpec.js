...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1beta1JobSpec = factory(root.Kubernetes.ApiClient, root.Kubernetes.UnversionedLabelSelector, root.Kubernetes.V1PodTemplateSpec);
  }
   ...
   * @alias module:model/V1beta1JobSpec
   * @class
   ...
   * @param {module:model/V1beta1JobSpec} obj Optional instance to populate.
   * @return {module:model/V1beta1JobSpec} The populated <code>V1beta1JobSpec</code> instance.
   */
