...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1beta1PolicyRule = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @module model/V1beta1PolicyRule
   * @version v1.6.0
   */
   ...
   * @alias module:model/V1beta1PolicyRule
   * @class
   ...
   * @param {module:model/V1beta1PolicyRule} obj Optional instance to populate.
   * @return {module:model/V1beta1PolicyRule} The populated <code>V1beta1PolicyRule</code> instance.
   */
