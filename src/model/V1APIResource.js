...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1APIResource = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @alias module:model/V1APIResource
   * @class
   ...
   * @param {module:model/V1APIResource} obj Optional instance to populate.
   * @return {module:model/V1APIResource} The populated <code>V1APIResource</code> instance.
   */
