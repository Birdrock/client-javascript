...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ServicePort'], factory);
    ...
    root.Kubernetes.V1ServiceSpec = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1ServicePort);
  }
   ...
   * @class
   * @param ports {Array.<module:model/V1ServicePort>} The list of ports that are exposed by this service. More info: http://kubernetes.io/docs/user-guide/services#virtual-ips-and-service-proxies
   */
   ...
   * @member {Array.<module:model/V1ServicePort>} ports
   */
