...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1GlusterfsVolumeSource = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @module model/V1GlusterfsVolumeSource
   * @version v1.6.0
   */
   ...
   * @alias module:model/V1GlusterfsVolumeSource
   * @class
   ...
   * @param {module:model/V1GlusterfsVolumeSource} obj Optional instance to populate.
   * @return {module:model/V1GlusterfsVolumeSource} The populated <code>V1GlusterfsVolumeSource</code> instance.
   */
