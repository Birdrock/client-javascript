...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1Capabilities = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @alias module:model/V1Capabilities
   * @class
   */
   ...
   * @param {module:model/V1Capabilities} obj Optional instance to populate.
   * @return {module:model/V1Capabilities} The populated <code>V1Capabilities</code> instance.
   */
