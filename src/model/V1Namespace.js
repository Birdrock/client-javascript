...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1NamespaceSpec', 'model/V1NamespaceStatus', 'model/V1ObjectMeta'], factory);
    ...
    root.Kubernetes.V1Namespace = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1NamespaceSpec, root.Kubernetes.V1NamespaceStatus, root.Kubernetes.V1ObjectMeta);
  }
   ...
   * @alias module:model/V1Namespace
   * @class
   */
   ...
   * @param {module:model/V1Namespace} obj Optional instance to populate.
   * @return {module:model/V1Namespace} The populated <code>V1Namespace</code> instance.
   */
   ...
   * @member {module:model/V1NamespaceSpec} spec
   */
   ...
   * @member {module:model/V1NamespaceStatus} status
   */
