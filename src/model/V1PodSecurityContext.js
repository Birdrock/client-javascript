...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1PodSecurityContext = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1SELinuxOptions);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('fsGroup')) {
        obj['fsGroup'] = ApiClient.convertToType(data['fsGroup'], 'Integer');
      }
      ...
      if (data.hasOwnProperty('supplementalGroups')) {
        obj['supplementalGroups'] = ApiClient.convertToType(data['supplementalGroups'], ['Integer']);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<Integer>} supplementalGroups
   */
