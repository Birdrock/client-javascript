...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1alpha1Role = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1ObjectMeta, root.Kubernetes.V1alpha1PolicyRule);
  }
   ...
   * @alias module:model/V1alpha1Role
   * @class
   * @param rules {Array.<module:model/V1alpha1PolicyRule>} Rules holds all the PolicyRules for this Role
   */
   ...
   * @param {module:model/V1alpha1Role} obj Optional instance to populate.
   * @return {module:model/V1alpha1Role} The populated <code>V1alpha1Role</code> instance.
   */
