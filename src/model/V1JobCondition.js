...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1JobCondition = factory(root.Kubernetes.ApiClient, root.Kubernetes.UnversionedTime);
  }
   ...
   * @alias module:model/V1JobCondition
   * @class
   ...
   * @param {module:model/V1JobCondition} obj Optional instance to populate.
   * @return {module:model/V1JobCondition} The populated <code>V1JobCondition</code> instance.
   */
