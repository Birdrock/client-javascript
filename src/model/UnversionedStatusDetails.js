...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UnversionedStatusCause'], factory);
    ...
    root.Kubernetes.UnversionedStatusDetails = factory(root.Kubernetes.ApiClient, root.Kubernetes.UnversionedStatusCause);
  }
   ...
   * @module model/UnversionedStatusDetails
   * @version unversioned
   */
   ...
   * @alias module:model/UnversionedStatusDetails
   * @class
   */
   ...
   * @param {module:model/UnversionedStatusDetails} obj Optional instance to populate.
   * @return {module:model/UnversionedStatusDetails} The populated <code>UnversionedStatusDetails</code> instance.
   */
   ...
   * @member {Array.<module:model/UnversionedStatusCause>} causes
   */
