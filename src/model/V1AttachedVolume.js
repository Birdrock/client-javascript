...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1AttachedVolume = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @alias module:model/V1AttachedVolume
   * @class
   ...
   * @param {module:model/V1AttachedVolume} obj Optional instance to populate.
   * @return {module:model/V1AttachedVolume} The populated <code>V1AttachedVolume</code> instance.
   */
