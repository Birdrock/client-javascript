...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1beta1SupplementalGroupsStrategyOptions = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1beta1IDRange);
  }
   ...
   * @module model/V1beta1SupplementalGroupsStrategyOptions
   * @version v1.6.0
   */
   ...
   * @alias module:model/V1beta1SupplementalGroupsStrategyOptions
   * @class
   */
   ...
   * @param {module:model/V1beta1SupplementalGroupsStrategyOptions} obj Optional instance to populate.
   * @return {module:model/V1beta1SupplementalGroupsStrategyOptions} The populated <code>V1beta1SupplementalGroupsStrategyOptions</code> instance.
   */
