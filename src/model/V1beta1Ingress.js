...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ObjectMeta', 'model/V1beta1IngressSpec', 'model/V1beta1IngressStatus'], factory);
    ...
    root.Kubernetes.V1beta1Ingress = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1ObjectMeta, root.Kubernetes.V1beta1IngressSpec, root.Kubernetes.V1beta1IngressStatus);
  }
   ...
   * @alias module:model/V1beta1Ingress
   * @class
   */
   ...
   * @param {module:model/V1beta1Ingress} obj Optional instance to populate.
   * @return {module:model/V1beta1Ingress} The populated <code>V1beta1Ingress</code> instance.
   */
   ...
   * @member {module:model/V1beta1IngressSpec} spec
   */
   ...
   * @member {module:model/V1beta1IngressStatus} status
   */
