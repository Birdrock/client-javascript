...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1GroupVersionForDiscovery = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @module model/V1GroupVersionForDiscovery
   * @version v1.6.0
   */
   ...
   * @alias module:model/V1GroupVersionForDiscovery
   * @class
   ...
   * @param {module:model/V1GroupVersionForDiscovery} obj Optional instance to populate.
   * @return {module:model/V1GroupVersionForDiscovery} The populated <code>V1GroupVersionForDiscovery</code> instance.
   */
