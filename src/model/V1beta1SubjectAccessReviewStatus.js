...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1beta1SubjectAccessReviewStatus = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @module model/V1beta1SubjectAccessReviewStatus
   * @version unversioned
   */
   ...
   * @alias module:model/V1beta1SubjectAccessReviewStatus
   * @class
   ...
   * @param {module:model/V1beta1SubjectAccessReviewStatus} obj Optional instance to populate.
   * @return {module:model/V1beta1SubjectAccessReviewStatus} The populated <code>V1beta1SubjectAccessReviewStatus</code> instance.
   */
