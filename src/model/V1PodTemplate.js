...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ObjectMeta', 'model/V1PodTemplateSpec'], factory);
    ...
    root.Kubernetes.V1PodTemplate = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1ObjectMeta, root.Kubernetes.V1PodTemplateSpec);
  }
   ...
   * @alias module:model/V1PodTemplate
   * @class
   */
   ...
   * @param {module:model/V1PodTemplate} obj Optional instance to populate.
   * @return {module:model/V1PodTemplate} The populated <code>V1PodTemplate</code> instance.
   */
