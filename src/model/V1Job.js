...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1JobSpec', 'model/V1JobStatus', 'model/V1ObjectMeta'], factory);
    ...
    root.Kubernetes.V1Job = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1JobSpec, root.Kubernetes.V1JobStatus, root.Kubernetes.V1ObjectMeta);
  }
   ...
   * @member {module:model/V1JobSpec} spec
   */
   ...
   * @member {module:model/V1JobStatus} status
   */
