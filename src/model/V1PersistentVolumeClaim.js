...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ObjectMeta', 'model/V1PersistentVolumeClaimSpec', 'model/V1PersistentVolumeClaimStatus'], factory);
    ...
    root.Kubernetes.V1PersistentVolumeClaim = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1ObjectMeta, root.Kubernetes.V1PersistentVolumeClaimSpec, root.Kubernetes.V1PersistentVolumeClaimStatus);
  }
   ...
   * @module model/V1PersistentVolumeClaim
   * @version v1.6.0
   */
   ...
   * @alias module:model/V1PersistentVolumeClaim
   * @class
   */
   ...
   * @param {module:model/V1PersistentVolumeClaim} obj Optional instance to populate.
   * @return {module:model/V1PersistentVolumeClaim} The populated <code>V1PersistentVolumeClaim</code> instance.
   */
   ...
   * @member {module:model/V1PersistentVolumeClaimSpec} spec
   */
   ...
   * @member {module:model/V1PersistentVolumeClaimStatus} status
   */
