...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UnversionedLabelSelector', 'model/V1PodTemplateSpec', 'model/V1beta1DeploymentStrategy', 'model/V1beta1RollbackConfig'], factory);
    ...
    root.Kubernetes.V1beta1DeploymentSpec = factory(root.Kubernetes.ApiClient, root.Kubernetes.UnversionedLabelSelector, root.Kubernetes.V1PodTemplateSpec, root.Kubernetes.V1beta1DeploymentStrategy, root.Kubernetes.V1beta1RollbackConfig);
  }
