...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ObjectMeta', 'model/V1ObjectReference'], factory);
    ...
    root.Kubernetes.V1Binding = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1ObjectMeta, root.Kubernetes.V1ObjectReference);
  }
   ...
   * @alias module:model/V1Binding
   * @class
   * @param target {module:model/V1ObjectReference} The target object that you want to bind to the standard object.
   */
   ...
   * @param {module:model/V1Binding} obj Optional instance to populate.
   * @return {module:model/V1Binding} The populated <code>V1Binding</code> instance.
   */
   ...
   * @member {module:model/V1ObjectReference} target
   */
