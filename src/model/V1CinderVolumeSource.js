...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1CinderVolumeSource = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @module model/V1CinderVolumeSource
   * @version v1.6.0
   */
   ...
   * @alias module:model/V1CinderVolumeSource
   * @class
   ...
   * @param {module:model/V1CinderVolumeSource} obj Optional instance to populate.
   * @return {module:model/V1CinderVolumeSource} The populated <code>V1CinderVolumeSource</code> instance.
   */
