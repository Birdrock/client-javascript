...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1EndpointSubset', 'model/V1ObjectMeta'], factory);
    ...
    root.Kubernetes.V1Endpoints = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1EndpointSubset, root.Kubernetes.V1ObjectMeta);
  }
   ...
   * @alias module:model/V1Endpoints
   * @class
   * @param subsets {Array.<module:model/V1EndpointSubset>} The set of all endpoints is the union of all subsets. Addresses are placed into subsets according to the IPs they share. A single address with multiple ports, some of which are ready and some of which are not (because they come from different containers) will result in the address being displayed in different subsets for the different ports. No address will appear in both Addresses and NotReadyAddresses in the same subset. Sets of addresses and ports that comprise a service.
   */
   ...
   * @param {module:model/V1Endpoints} obj Optional instance to populate.
   * @return {module:model/V1Endpoints} The populated <code>V1Endpoints</code> instance.
   */
   ...
   * @member {Array.<module:model/V1EndpointSubset>} subsets
   */
