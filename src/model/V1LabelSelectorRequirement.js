...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1LabelSelectorRequirement = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @module model/V1LabelSelectorRequirement
   * @version v1.6.0
   */
   ...
   * @alias module:model/V1LabelSelectorRequirement
   * @class
   ...
   * @param {module:model/V1LabelSelectorRequirement} obj Optional instance to populate.
   * @return {module:model/V1LabelSelectorRequirement} The populated <code>V1LabelSelectorRequirement</code> instance.
   */
