...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1SecretVolumeSource = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1KeyToPath);
  }
   ...
   * @module model/V1SecretVolumeSource
   * @version v1.6.0
   */
   ...
   * @alias module:model/V1SecretVolumeSource
   * @class
   */
   ...
   * @param {module:model/V1SecretVolumeSource} obj Optional instance to populate.
   * @return {module:model/V1SecretVolumeSource} The populated <code>V1SecretVolumeSource</code> instance.
   */
