...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ObjectMeta', 'model/V1beta1DaemonSetSpec', 'model/V1beta1DaemonSetStatus'], factory);
    ...
    root.Kubernetes.V1beta1DaemonSet = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1ObjectMeta, root.Kubernetes.V1beta1DaemonSetSpec, root.Kubernetes.V1beta1DaemonSetStatus);
  }
   ...
   * @alias module:model/V1beta1DaemonSet
   * @class
   */
   ...
   * @param {module:model/V1beta1DaemonSet} obj Optional instance to populate.
   * @return {module:model/V1beta1DaemonSet} The populated <code>V1beta1DaemonSet</code> instance.
   */
   ...
   * @member {module:model/V1beta1DaemonSetSpec} spec
   */
   ...
   * @member {module:model/V1beta1DaemonSetStatus} status
   */
