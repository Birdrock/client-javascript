...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1NodeSystemInfo = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @alias module:model/V1NodeSystemInfo
   * @class
   ...
   * @param {module:model/V1NodeSystemInfo} obj Optional instance to populate.
   * @return {module:model/V1NodeSystemInfo} The populated <code>V1NodeSystemInfo</code> instance.
   */
