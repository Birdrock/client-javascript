...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1HTTPHeader = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @alias module:model/V1HTTPHeader
   * @class
   ...
   * @param {module:model/V1HTTPHeader} obj Optional instance to populate.
   * @return {module:model/V1HTTPHeader} The populated <code>V1HTTPHeader</code> instance.
   */
