...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UnversionedTime', 'model/V1ObjectReference'], factory);
    ...
    root.Kubernetes.V2alpha1CronJobStatus = factory(root.Kubernetes.ApiClient, root.Kubernetes.UnversionedTime, root.Kubernetes.V1ObjectReference);
  }
   ...
   * @member {module:model/UnversionedTime} lastScheduleTime
   */
