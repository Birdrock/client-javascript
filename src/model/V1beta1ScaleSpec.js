...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1beta1ScaleSpec = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @alias module:model/V1beta1ScaleSpec
   * @class
   */
   ...
   * @param {module:model/V1beta1ScaleSpec} obj Optional instance to populate.
   * @return {module:model/V1beta1ScaleSpec} The populated <code>V1beta1ScaleSpec</code> instance.
   */
