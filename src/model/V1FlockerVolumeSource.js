...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1FlockerVolumeSource = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @module model/V1FlockerVolumeSource
   * @version unversioned
   */
   ...
   * @alias module:model/V1FlockerVolumeSource
   * @class
   */
   ...
   * @param {module:model/V1FlockerVolumeSource} obj Optional instance to populate.
   * @return {module:model/V1FlockerVolumeSource} The populated <code>V1FlockerVolumeSource</code> instance.
   */
