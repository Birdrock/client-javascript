...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1NodeCondition = factory(root.Kubernetes.ApiClient, root.Kubernetes.UnversionedTime);
  }
   ...
   * @alias module:model/V1NodeCondition
   * @class
   ...
   * @param {module:model/V1NodeCondition} obj Optional instance to populate.
   * @return {module:model/V1NodeCondition} The populated <code>V1NodeCondition</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('lastHeartbeatTime')) {
        obj['lastHeartbeatTime'] = UnversionedTime.constructFromObject(data['lastHeartbeatTime']);
      }
   ...
   * @member {module:model/UnversionedTime} lastHeartbeatTime
   */
