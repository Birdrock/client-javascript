...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1NodeCondition = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1Time);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('lastHeartbeatTime')) {
        obj['lastHeartbeatTime'] = V1Time.constructFromObject(data['lastHeartbeatTime']);
      }
   ...
   * @member {module:model/V1Time} lastHeartbeatTime
   */
