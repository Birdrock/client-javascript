...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ObjectMeta', 'model/V1beta1APIVersion'], factory);
    ...
    root.Kubernetes.V1beta1ThirdPartyResource = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1ObjectMeta, root.Kubernetes.V1beta1APIVersion);
  }
   ...
   * @module model/V1beta1ThirdPartyResource
   * @version v1.6.0
   */
   ...
   * @alias module:model/V1beta1ThirdPartyResource
   * @class
   */
   ...
   * @param {module:model/V1beta1ThirdPartyResource} obj Optional instance to populate.
   * @return {module:model/V1beta1ThirdPartyResource} The populated <code>V1beta1ThirdPartyResource</code> instance.
   */
   ...
   * @member {Array.<module:model/V1beta1APIVersion>} versions
   */
