...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.UnversionedServerAddressByClientCIDR = factory(root.Kubernetes.ApiClient);
  }
   ...
   * @module model/UnversionedServerAddressByClientCIDR
   * @version unversioned
   */
   ...
   * @alias module:model/UnversionedServerAddressByClientCIDR
   * @class
   ...
   * @param {module:model/UnversionedServerAddressByClientCIDR} obj Optional instance to populate.
   * @return {module:model/UnversionedServerAddressByClientCIDR} The populated <code>UnversionedServerAddressByClientCIDR</code> instance.
   */
