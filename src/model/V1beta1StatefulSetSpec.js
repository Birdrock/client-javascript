...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1LabelSelector', 'model/V1PersistentVolumeClaim', 'model/V1PodTemplateSpec'], factory);
    ...
    root.Kubernetes.V1beta1StatefulSetSpec = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1LabelSelector, root.Kubernetes.V1PersistentVolumeClaim, root.Kubernetes.V1PodTemplateSpec);
  }
