...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UnversionedLabelSelector', 'model/V1PersistentVolumeClaim', 'model/V1PodTemplateSpec'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UnversionedLabelSelector'), require('./V1PersistentVolumeClaim'), require('./V1PodTemplateSpec'));
  } else {
    // Browser globals (root is window)
    if (!root.Kubernetes) {
      root.Kubernetes = {};
    }
    root.Kubernetes.V1beta1StatefulSetSpec = factory(root.Kubernetes.ApiClient, root.Kubernetes.UnversionedLabelSelector, root.Kubernetes.V1PersistentVolumeClaim, root.Kubernetes.V1PodTemplateSpec);
  }
}(this, function(ApiClient, UnversionedLabelSelector, V1PersistentVolumeClaim, V1PodTemplateSpec) {
  'use strict';
   ...
   * @module model/V1beta1StatefulSetSpec
   * @version unversioned
   */
   ...
   * @alias module:model/V1beta1StatefulSetSpec
   * @class
   ...
   * @param template {module:model/V1PodTemplateSpec} Template is the object that describes the pod that will be created if insufficient replicas are detected. Each pod stamped out by the StatefulSet will fulfill this Template, but have a unique identity from the rest of the StatefulSet.
   */
   ...
   * @param {module:model/V1beta1StatefulSetSpec} obj Optional instance to populate.
   * @return {module:model/V1beta1StatefulSetSpec} The populated <code>V1beta1StatefulSetSpec</code> instance.
   */
   ...
   * @member {Array.<module:model/V1PersistentVolumeClaim>} volumeClaimTemplates
   */
