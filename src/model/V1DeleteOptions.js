...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1Preconditions'], factory);
    ...
    root.Kubernetes.V1DeleteOptions = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1Preconditions);
  }
   ...
   * @alias module:model/V1DeleteOptions
   * @class
   */
   ...
   * @param {module:model/V1DeleteOptions} obj Optional instance to populate.
   * @return {module:model/V1DeleteOptions} The populated <code>V1DeleteOptions</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('gracePeriodSeconds')) {
        obj['gracePeriodSeconds'] = ApiClient.convertToType(data['gracePeriodSeconds'], 'Integer');
      }
   ...
   * @member {Integer} gracePeriodSeconds
   */
   ...
   * @member {module:model/V1Preconditions} preconditions
   */
