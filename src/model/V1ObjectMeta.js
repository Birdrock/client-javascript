...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UnversionedTime', 'model/V1OwnerReference'], factory);
    ...
    root.Kubernetes.V1ObjectMeta = factory(root.Kubernetes.ApiClient, root.Kubernetes.UnversionedTime, root.Kubernetes.V1OwnerReference);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('deletionGracePeriodSeconds')) {
        obj['deletionGracePeriodSeconds'] = ApiClient.convertToType(data['deletionGracePeriodSeconds'], 'Integer');
      }
   ...
   * @member {module:model/UnversionedTime} creationTimestamp
   */
  exports.prototype['creationTimestamp'] = undefined;
  /**
   * Number of seconds allowed for this object to gracefully terminate before it will be removed from the system. Only set when deletionTimestamp is also set. May only be shortened. Read-only.
   * @member {Integer} deletionGracePeriodSeconds
   */
   ...
   * @member {module:model/UnversionedTime} deletionTimestamp
   */
