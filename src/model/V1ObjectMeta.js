...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1OwnerReference', 'model/V1Time'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V1OwnerReference'), require('./V1Time'));
  } else {
    // Browser globals (root is window)
    if (!root.Kubernetes) {
      root.Kubernetes = {};
    }
    root.Kubernetes.V1ObjectMeta = factory(root.Kubernetes.ApiClient, root.Kubernetes.V1OwnerReference, root.Kubernetes.V1Time);
  }
}(this, function(ApiClient, V1OwnerReference, V1Time) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('creationTimestamp')) {
        obj['creationTimestamp'] = V1Time.constructFromObject(data['creationTimestamp']);
      }
      ...
      if (data.hasOwnProperty('deletionTimestamp')) {
        obj['deletionTimestamp'] = V1Time.constructFromObject(data['deletionTimestamp']);
      }
   ...
   * @member {module:model/V1Time} creationTimestamp
   */
   ...
   * @member {module:model/V1Time} deletionTimestamp
   */
