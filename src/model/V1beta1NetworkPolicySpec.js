...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UnversionedLabelSelector', 'model/V1beta1NetworkPolicyIngressRule'], factory);
    ...
    root.Kubernetes.V1beta1NetworkPolicySpec = factory(root.Kubernetes.ApiClient, root.Kubernetes.UnversionedLabelSelector, root.Kubernetes.V1beta1NetworkPolicyIngressRule);
  }
   ...
   * @class
   * @param podSelector {module:model/UnversionedLabelSelector} Selects the pods to which this NetworkPolicy object applies.  The array of ingress rules is applied to any pods selected by this field. Multiple network policies can select the same set of pods.  In this case, the ingress rules for each are combined additively. This field is NOT optional and follows standard label selector semantics. An empty podSelector matches all pods in this namespace.
   */
