...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Kubernetes.V1beta1ReplicaSetCondition = factory(root.Kubernetes.ApiClient, root.Kubernetes.UnversionedTime);
  }
   ...
   * @module model/V1beta1ReplicaSetCondition
   * @version unversioned
   */
   ...
   * @alias module:model/V1beta1ReplicaSetCondition
   * @class
   ...
   * @param {module:model/V1beta1ReplicaSetCondition} obj Optional instance to populate.
   * @return {module:model/V1beta1ReplicaSetCondition} The populated <code>V1beta1ReplicaSetCondition</code> instance.
   */
